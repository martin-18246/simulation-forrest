...
public static class BaseTraitSettings
{
    ...
    public static float pregnancyTimeBaseRabbit = 5;
    public static float pregnancyTimeDifRabbit = 2;

    public static float reproductionCooldownBaseRabbit = 10;
    public static float reproductionCooldownDifRabbit = 2;

    public static float maximumAgeBaseRabbit = 180;
    public static float maximumAgeDifRabbit = 20;

    public static float maturityAgeBaseRabbit = 20;
